...
Six-panel log-scale plot showing influence decay for six synthetic models
(surrogates for Enformer, Borzoi, HyenaDNA, Caduceus, DNABERT-2, Evo-2),
averaged over promoter-centered loci. Two perturbation types: substitution
and dinucleotide shuffle. Shaded +/-1 SE bands.
"""
...
def main():
    ...
    fig.suptitle(
        "Figure 1: Influence Profiles for Promoter-Centered Loci",
        fontsize=14,
        fontweight="bold",
        y=0.98,
    )
