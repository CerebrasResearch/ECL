...
\ref{alg:surrogate}: Surrogate & $M \times n$ & $O(Md)$ & $M \ll L$ sampled positions; per-position cost may be amortized via fast ISM~\citep{Nair2022fastISM,Schreiber2022Yuzu} \\
...
The main computational bottleneck, the independent forward passes for different perturbations, is embarrassingly parallel. We recommend:
